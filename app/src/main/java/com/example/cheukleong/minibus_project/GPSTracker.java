...
public class GPSTracker extends Service
{
    ...
    public static double journey_endlocation_x;
    public static double journey_startlocation_x;
    public static double journey_endlocation_y;
    public static double journey_startlocation_y;
    ...
    public Long journey_start_time;
    public Long journey_end_time;
        ...
        Log.e(TAG, "init_y_inside location: "+endlocation_y);
            ...
            for(int i=0; i<2;i++) {
                ...
                if(distance<dans)
                {
                    ...
                    Date currentLocalTime = cal.getTime();
                    localTime_date = currentLocalTime;
                    journey_start_time=currentLocalTime.getTime();
                    start_time = currentLocalTime.getTime();
                    startlocation_x = cur_location.getLatitude();
                    startlocation_y = cur_location.getLongitude();
                    journey_startlocation_x = cur_location.getLatitude();
                    journey_startlocation_y = cur_location.getLongitude();
                    Log.e(TAG, "init=" + init);
                    dans=30;
                    break;
                }
        ...
        if(go_back==0)
        {
            for(int i=0; i<6;i++) {
                ...
                if(distance<dans && arr_station!=i && send_i!=i)
                {
                    ...
                    if(i==5)
                    {
                        journey_endlocation_x = cur_location.getLatitude();
                        journey_endlocation_y = cur_location.getLongitude();
                        journey_end_time=currentLocalTime.getTime();
                        show_journey();
                        send_journey_data();
                        journey_start_time = currentLocalTime.getTime();
                        journey_startlocation_x = cur_location.getLatitude();
    ...
    HttpPost httppost = new HttpPost("http://172.104.95.252:3001/api/v1/minibus/insertStation");
    ...
    try {
        ...
        nameValuePairs.add(new BasicNameValuePair("stationid", journey_start_time+CAR_ID+temp_i));
        ...
        nameValuePairs.add(new BasicNameValuePair("journeyid", journey_start_time+CAR_ID));
    ...
    private void update_data(){
        ...
        DefaultHttpClient client = new DefaultHttpClient();
        Log.d(TAG, "send_station_data: 3");
        HttpPost httppost = new HttpPost("http://172.104.95.252:3001/api/v1/minibus/insertLocation");
        Log.d(TAG, "send_station_data: 4");
    ...
    private void send_journey_data(){
        Log.d(TAG, "send_journey_data: 0");
        Map< String, Object > journey_start_location_array = new HashMap< String, Object >();
        journey_start_location_array.put("x", journey_startlocation_x);
        journey_start_location_array.put("y", journey_startlocation_y);
        Log.d(TAG, "send_journey_data: 1");
        JSONObject journey_start_location_json = new JSONObject(journey_start_location_array);


        Map< String, Object > journey_end_location_array = new HashMap< String, Object >();
        journey_end_location_array.put("x", journey_endlocation_x);
        journey_end_location_array.put("y", journey_endlocation_y);
        Log.d(TAG, "send_journey_data: 1");
        JSONObject journey_end_location_json = new JSONObject(journey_end_location_array);


        Log.d(TAG, "send_journey_data: 2");
        DefaultHttpClient client = new DefaultHttpClient();
        Log.d(TAG, "send_journey_data: 3");
        HttpPost httppost = new HttpPost("http://172.104.95.252:3001/api/v1/minibus/insertJourney");
        Log.d(TAG, "send_journey_data: 4");


        Log.d(TAG, "send_journey_data: 5");
        try {
            // Add your data
            List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
            nameValuePairs.add(new BasicNameValuePair("journeyid", journey_start_time+CAR_ID));
            nameValuePairs.add(new BasicNameValuePair("startlocation", journey_start_location_json.toString()));
            nameValuePairs.add(new BasicNameValuePair("endlocation", journey_end_location_json.toString()));
            nameValuePairs.add(new BasicNameValuePair("startTime", journey_start_time.toString()));
            nameValuePairs.add(new BasicNameValuePair("endTime", journey_end_time.toString()));
    ...
    public void show_journey(){
        ...
        Log.e(TAG,"Jouruney_start_location = "+journey_startlocation_x+" , "+journey_startlocation_y);
        Log.e(TAG,"Jouruney_end_location = "+journey_endlocation_x+" , "+journey_endlocation_y);
        Log.e(TAG, "Jouruney_start_time = "+journey_start_time);
        Log.e(TAG,"Jouruney_end_time = "+journey_end_time);
        Log.e(TAG, "Journeyid = "+journey_start_time+CAR_ID);
    }

    public void show_stations() {
        Log.e(TAG, "It's time to send the stations information:");
        Log.e(TAG, "Station_id" + journey_start_time + CAR_ID + send_i);
    ...
    private class mainTask extends TimerTask
    {
        public void run()
        {
            ...
            Calendar cal = Calendar.getInstance();
            Date currentLocalTime = cal.getTime();
            Log.e(TAG,"currentLocalTime = "+currentLocalTime);
            int start_plane = 0;
            int end_plane =0;
